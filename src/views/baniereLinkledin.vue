<template>
    ...
    <div ref="vantaRef" class="w-full h-screen z-40  overflow-hidden">
        <section id="accueil"
            class=" w-full z-50 text-black font-poppins px-4 md:px-8 lg:px-16 py-12 md:py-20 mt-[80px] md:mt-[100px]">

            <!-- Container principal -->
            <div
                class="max-w-7xl  h-full mx-auto mb-9 flex flex-col-reverse md:flex-row  md:h-fit items-center justify-between gap-8 md:gap-12">
                ...
                <div class="flex flex-col gap-6 md:gap-8 w-full md:w-3/5 lg:w-1/2">
                    ...
                    <div class="flex flex-col gap-4 text-center md:text-left">
                        ...
                        <!-- Sous-titre -->
                        <h2 class="text-[20px] md:text-[26px] lg:text-[32px] font-semibold text-black">
                            Développeuse Fullstack Junior
                        </h2>

                        <!-- Description -->
                        <p class="text-[16px] md:text-[18px] lg:text-[20px] text-black leading-relaxed">
                    ...
                    <div class="flex gap-6 mt-6 justify-center md:justify-start text-gray-600">
                        <a href="https://github.com/marie123fotue">
    ...
    <div ref="vantaRef1" class="w-full h-screen z-40  overflow-hidden">
        <!-- Section À Propos -->
        <section id="Apropos" class="min-h-screen  py-20 px-6 bg-[#000A2B]">
                ...
                <div class="grid md:grid-cols-2 md:gap-12 gap-8 ">
                    ...
                    <div class="flex-1 flex-col ">
                        ...
                        <div
                            ...
                            <h3 class="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-[#0FDBD0]">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div
                        ...
                        <ul class="space-y-3 text-gray-300">
                            ...
                            <li class="flex items-start gap-3">
                                <span class="text-[#0FDBD0] text-xl mt-1">✓</span>
                                <span class="text-[16px]">Gestion des projets <strong class="text-white">jira</strong>
                                    et
    ...
    <section id="projet" class="min-h-screen bg-gray-50 py-20 px-6 z-45">
        <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8 md:mb-12">
                    ...
                    <div class="space-y-4 text-center md:text-left">
                        ...
                        <ul class="space-y-3 text-gray-400 text-sm">
                            <li>
                                <a href="#"
                                    class="hover:text-[#0EA5E9] transition-colors inline-block hover:translate-x-1 duration-300">
                                    Design UI/UX
                                </a>
                            </li>
                            <li>
...
onMounted(() => {
    if (window.VANTA) {
        ...
        //         showLines: true
        //     });
        vantaEffect1 = window.VANTA.DOTS({
            el: vantaRef1.value,
            mouseControls: true,
            touchControls: true,
            gyroControls: false,
...
onBeforeUnmount(() => {
    if (vantaEffect1) vantaEffect1.destroy(); // Nettoyage pour éviter les fuites mémoire
});
</script>
<style scoped>
